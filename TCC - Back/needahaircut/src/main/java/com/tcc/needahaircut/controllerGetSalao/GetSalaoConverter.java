package com.tcc.needahaircut.controllerGetSalao;

import com.tcc.needahaircut.controllerGetSalao.GetSalaoDTO;
...
public class GetSalaoConverter {
    ...
    public List<GetSalaoDTO> convertToDtoTeste(List<SalaoEntity> entities) {
