...
public class EnderecoDTO {
    ...
    public EnderecoDTO(int endereco_id, String endereco_bairro, String endereco_rua, String endereco_numero, String endereco_complemento, CidadeEntity cidadeEntity) {
