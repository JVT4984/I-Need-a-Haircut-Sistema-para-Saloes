...
public class EnderecoDTO {
    ...
    public int cidade_cidade_id;

    public EnderecoDTO(int endereco_id, String endereco_bairro, String endereco_rua, String endereco_numero, String endereco_complemento, int cidade_cidade_id) {
    ...
    public int getCidade_cidade_id() {
        return cidade_cidade_id;
    }

    public void setCidade_cidade_id(int cidade_cidade_id) {
        this.cidade_cidade_id = cidade_cidade_id;
    }
